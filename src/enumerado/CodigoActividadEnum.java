...
public enum CodigoActividadEnum {
  ...
  UCI(8, "HABITACION EN UCI"),
  EN_PLANTA(9, "HABITACION EN PLANTA"),
  CONSULTA_APARATO_DIGESTIVO(10, "CONSULTA DE APARATO DIGESTIVO"),
  CONSULTA_CARDIOLOGIA(11, "CONSULTA DE CARDIOLOGIA"),
  CONSULTA_CIRUGIA_GENERAL(12, "CONSULTA DE CIRUGIA GENERAL"),
  CONSULTA_DERMATOLOGIA(13, "CONSULTA DE DERMATOLOGIA"),
  CONSULTA_MEDICINA_INTERNA(14, "CONSULTA DE MEDICINA INTERNA"),
  CONSULTA_ONCOLOGIA(15, "CONSULTA DE ONCOLOGIA"),
  CONSULTA_OFTALMOLOGIA(16, "CONSULTA DE OFTALMOLOGIA"),
  CONSULTA_PRIMARIA(17, "CONSULTA PRIMARIA"),
  CONSULTA_PSIQUIATRIA(18, "CONSULTA DE PSIQUIATRIA"),
  CONSULTA_TRAUMATOLOGIA(19, "CONSULTA DE TRAUMATOLOGIA"),
